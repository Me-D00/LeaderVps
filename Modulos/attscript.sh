...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/Me-D00/LeaderVps/master/Install/versao
...
echo -e "                              \033[1;31mBy LeaderVps\033[1;36m"

echo -e "   LeaderVps" | figlet | lolcat -a
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;36m     SCRIPT IS ALREADY UPDATED!\033[1;32m\n"

  rm /tmp/att > /dev/null 2>&1

  echo -e " \033[1;33m MORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@LeoMedo\n"
  ...
  echo -e "  \033[1;33mMORE INFORMATION \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@LeoMedo\n"
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/Me-D00/LeaderVps/master/LeaderVps > /dev/null 2>&1

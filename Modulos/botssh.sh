...
fun_botOnOff () {
      [[ $(ps x | grep "bot_plus"|grep -v grep | wc -l) = '0' ]] && {
          clear
          echo -e "\E[44;1;37m             BOT LeaderVps INSTALLER                \E[0m\n"
          echo -ne "\033[1;32mREPORT YOUR TOKEN:\033[1;37m "; read tokenbot
  	    echo ""
  	    echo -ne "\033[1;32mINFORM YOUR ID:\033[1;37m "; read iduser
          clear
          echo -e "\033[1;32mSTARTING BOT LeaderVps \033[0m\n"
          fun_bot1 () {
          ...
          fun_bar 'fun_bot2'
          echo -e "\n\033[1;32m \033[1;31mBOT STOOPED! \033[0m"
          sleep 3
          menu
      }
}
...
fun_instbot () {
echo -e "\E[44;1;37m             INSTALADOR BOT LeaderVps                \E[0m\n"
...
echo -e "\n\033[1;32m3° \033[1;37m- \033[1;33mBOT \033[1;37m@EdRobot \033[1;33mAND GET YOUR ID \033[1;31mOPTION: \033[1;37m/id\033[0m"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[1;32m"
echo ""
read -p "DO YOU WANT TO CONTINUE ? [s/n]: " -e -i n resposta
if [[ "$resposta" = 's' ]]; then
  	fun_botOnOff
  else
